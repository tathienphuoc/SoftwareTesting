...
public class Add extends TestCSS {
    ...
    public void testAddButton() {
        ...
        String expect_color_add_button = "#000000";
        String expect_background_color_add_button = "#000000";
        String expect_text_add_button = "Thêm sản phẩm";
        int expect_height_add_button = 40;

        testColor(add_button, expect_color_add_button);
        testBackgroundColor(add_button, expect_background_color_add_button);
        testText(add_button, expect_text_add_button);
        testHeight(add_button, expect_height_add_button);
...
//        driver.close();
    ...
    public void testAddForm() {
        ...
        String expect_text_header = "Thêm sản phẩm";
        ...
        String expect_text_book_image_title = "Thêm ảnh sản phẩm";
        ...
        //Author Dropdown
        WebElement author_dropdown = getWebElementByCSSSelector(driver, "div.form-group:nth-child(2) > div:nth-child(2) > select:nth-child(1)");
        ...
        WebElement book_category_dropdown = getWebElementByCSSSelector(driver, "div.form-group:nth-child(4) > div:nth-child(2) > select:nth-child(1)");
        ...
        //Save add
        WebElement save_add_button = getWebElementByCSSSelector(driver, "#btnSubmit");
        String expect_color_save_add_button = "#ffffff";
        String expect_background_color_save_add_button = "#337ab7";
        String expect_text_save_add_button = "Lưu";
        int expect_height_save_add_button = 34;

        testColor(save_add_button, expect_color_save_add_button);
        testBackgroundColor(save_add_button, expect_background_color_save_add_button);
        testValue(save_add_button, expect_text_save_add_button);
        testHeight(save_add_button, expect_height_save_add_button);
